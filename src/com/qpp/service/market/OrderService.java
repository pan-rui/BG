...
//消费
public Map<String,String> paypal(PaymentRequest paymentRequest,OrderServiceImpl.PayType type);

    //查询
    public Map<String,String> findTransaction(PaymentRequest findRequest,OrderServiceImpl.PayType type);

    //消费撤消
    public Map<String,String> cancelPay(PaymentRequest cancelRequest,OrderServiceImpl.PayType type);

    //预授权
    public Map<String,String> preAuth(PaymentRequest preAuthRequest,OrderServiceImpl.PayType type);
    ...
    //退款
    public Map<String,String> refund(PaymentRequest refundRequest,OrderServiceImpl.PayType type);
}

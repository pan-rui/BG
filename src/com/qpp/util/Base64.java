...
public class Base64 {
     ...
     * @return The Base64-encoded object
     * @see com.qpp.util.Base64#GZIP
     * @see com.qpp.util.Base64#DONT_BREAK_LINES
     * @since 2.0
     */
    public static String encodeObject(java.io.Serializable serializableObject,
            int options) {
    ...
    public static boolean encodeToFile(byte[] dataToEncode, String filename) {
        ...
        try {
            bos =
                    new OutputStream(new java.io.FileOutputStream(filename),
                                            Base64.ENCODE);
    ...
    public static byte[] decodeFromFile(String filename) {
        ...
        try {
            ...
            // Open a stream
            bis =
                    new InputStream(new java.io.BufferedInputStream(new java.io.FileInputStream(file)),
                                           Base64.DECODE);
    ...
    /**
     * A {@link com.qpp.util.Base64.InputStream} will read data from another
     * <tt>java.io.InputStream</tt>, given in the constructor,
     * and encode/decode to/from Base64 notation on the fly.
     *
     * @see com.qpp.util.Base64
     * @since 1.3
     */
    public static class InputStream extends java.io.FilterInputStream {
        ...
        /**
         * Constructs a {@link com.qpp.util.Base64.InputStream} in DECODE mode.
         *
        ...
        /**
         * Constructs a {@link com.qpp.util.Base64.InputStream} in
         ...
         * @param in the <tt>java.io.InputStream</tt> from which to read data.
         * @param options Specified options
         * @see com.qpp.util.Base64#ENCODE
         * @see com.qpp.util.Base64#DECODE
         * @see com.qpp.util.Base64#DONT_BREAK_LINES
         * @since 2.0
         */
    ...
    /**
     * A {@link com.qpp.util.Base64.OutputStream} will write data to another
    ...
    public static class OutputStream extends java.io.FilterOutputStream {
        ...
        /**
         * Constructs a {@link com.qpp.util.Base64.OutputStream} in ENCODE mode.
         *
        ...
        /**
         * Constructs a {@link com.qpp.util.Base64.OutputStream} in
         * either ENCODE or DECODE mode.
         * <p>
         * Valid options:<pre>
         *   ENCODE or DECODE: Encode or Decode as data is read.

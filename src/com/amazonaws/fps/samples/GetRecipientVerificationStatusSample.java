...
import com.amazonaws.fps.model.GetRecipientVerificationStatusResult;
 ...
 *
 */
public class GetRecipientVerificationStatusSample {
    ...
    public static void main(String... args) {
         ...
         * sample for Get Recipient Verification Status 
         ***********************************************************************/
         GetRecipientVerificationStatusRequest request = new GetRecipientVerificationStatusRequest();
     ...
     */
    public static void invokeGetRecipientVerificationStatus(AmazonFPS service, GetRecipientVerificationStatusRequest request) {
        try {
            
            GetRecipientVerificationStatusResponse response = service.getRecipientVerificationStatus(request);

            
            System.out.println ("GetRecipientVerificationStatus Action Response");
            System.out.println ("=============================================================================");
            System.out.println ();

            System.out.println("    GetRecipientVerificationStatusResponse");
            System.out.println();
            if (response.isSetGetRecipientVerificationStatusResult()) {
                System.out.println("        GetRecipientVerificationStatusResult");
                System.out.println();
                GetRecipientVerificationStatusResult getRecipientVerificationStatusResult = response.getGetRecipientVerificationStatusResult();
                if (getRecipientVerificationStatusResult.isSetRecipientVerificationStatus()) {
                    System.out.println("            RecipientVerificationStatus");
                    System.out.println();
                    System.out.println("                " + getRecipientVerificationStatusResult.getRecipientVerificationStatus().value());
                    System.out.println();
                }
            } 

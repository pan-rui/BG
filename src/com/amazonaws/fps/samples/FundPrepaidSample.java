...
import com.amazonaws.fps.model.FundPrepaidResult;
...
public class FundPrepaidSample {
     ...
     */
    public static void invokeFundPrepaid(AmazonFPS service, FundPrepaidRequest request) {
        try {
            
            FundPrepaidResponse response = service.fundPrepaid(request);
            ...
            if (response.isSetFundPrepaidResult()) {
                ...
                System.out.println();
                FundPrepaidResult fundPrepaidResult = response.getFundPrepaidResult();

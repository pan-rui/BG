 ...
 *
 */
public class GetSubscriptionDetailsAsyncSample {
    ...
    public static void main(String... args) {
         ...
         * requests to process.
         ***********************************************************************/
         GetSubscriptionDetailsRequest requestOne = new GetSubscriptionDetailsRequest();
         // @TODO: set request parameters here

         GetSubscriptionDetailsRequest requestTwo = new GetSubscriptionDetailsRequest();
         // @TODO: set second request parameters here

         List<GetSubscriptionDetailsRequest> requests = new ArrayList<GetSubscriptionDetailsRequest>();
         requests.add(requestOne);
         requests.add(requestTwo);

         invokeGetSubscriptionDetails(service, requests);
     ...
     */
    public static void invokeGetSubscriptionDetails(AmazonFPSAsync service, List<GetSubscriptionDetailsRequest> requests) {
        ...
        for (GetSubscriptionDetailsRequest request : requests) {
            responses.add(service.getSubscriptionDetailsAsync(request));
        }
        for (Future<GetSubscriptionDetailsResponse> future : responses) {
            ...
            try {
                ...
                GetSubscriptionDetailsRequest originalRequest = requests.get(responses.indexOf(future));

...
public class GetTokensSample {
     ...
     */
    public static void invokeGetTokens(AmazonFPS service, GetTokensRequest request) {
        try {
            
            GetTokensResponse response = service.getTokens(request);
            ...
            if (response.isSetGetTokensResult()) {
                ...
                System.out.println();
                GetTokensResult  getTokensResult = response.getGetTokensResult();
                List<Token> tokenList = getTokensResult.getToken();

    ...
    public static void invokeGetTransaction(AmazonFPS service, GetTransactionRequest request) {
        try {
            ...
            if (response.isSetGetTransactionResult()) {
                ...
                System.out.println();
                GetTransactionResult  getTransactionResult = response.getGetTransactionResult();
                if (getTransactionResult.isSetTransaction()) {
                    ...
                    List<RelatedTransaction> relatedTransactionList = transaction.getRelatedTransaction();
                    ...
                    List<StatusHistory> statusHistoryList = transaction.getStatusHistory();

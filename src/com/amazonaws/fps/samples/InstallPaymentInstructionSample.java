...
import com.amazonaws.fps.model.InstallPaymentInstructionResult;
    ...
    public static void invokeInstallPaymentInstruction(AmazonFPS service, InstallPaymentInstructionRequest request) {
        try {
            ...
            if (response.isSetInstallPaymentInstructionResult()) {
                ...
                System.out.println();
                InstallPaymentInstructionResult installPaymentInstructionResult = response.getInstallPaymentInstructionResult();

 ...
 *         &lt;element name="SettlementAmount" type="{http://fps.amazonaws.com/doc/2010-08-28/}Amount" minOccurs="0"/>
...
public class SettleDebtRequest {
     ...
     * 
     */
    public SettleDebtRequest(final String senderTokenId, final String creditInstrumentId, final Amount settlementAmount, final String callerReference, final String senderDescription, final String callerDescription, final DescriptorPolicy descriptorPolicy, final Integer transactionTimeoutInMins, final String overrideIPNURL) {
     ...
     *     this instance
     */
    public SettleDebtRequest withOverrideIPNURL(String value) {

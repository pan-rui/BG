...
public class AmazonFPSAsyncClient extends AmazonFPSClient implements AmazonFPSAsync {
    ...
    /**
     * Non-blocking Get Transactions For Subscription 
     * <p/>
     * Returns <code>future</code> pointer to GetTransactionsForSubscriptionResponse
     * <p/>
     * If response is ready, call to <code>future.get()</code> 
     * will return GetTransactionsForSubscriptionResponse. 
     * <p/>
     * If response is not ready, call to <code>future.get()</code> will block the 
     * calling thread until response is returned. 
     * <p/>
     ...
     *      responses.add(client.getTransactionsForSubscriptionAsync(request));
     *  }
     ...
     * @return Future&lt;GetTransactionsForSubscriptionResponse&gt; future pointer to GetTransactionsForSubscriptionResponse
     * 
     */
    public Future<GetTransactionsForSubscriptionResponse> getTransactionsForSubscriptionAsync(final GetTransactionsForSubscriptionRequest request) {
        Future<GetTransactionsForSubscriptionResponse> response = executor.submit(new Callable<GetTransactionsForSubscriptionResponse>() {

            public GetTransactionsForSubscriptionResponse call() throws AmazonFPSException {
                return getTransactionsForSubscription(request);
            }
        });
        return response;
    }
    ...
    /**
     * Non-blocking Get Subscription Details 
     * <p/>
     * Returns <code>future</code> pointer to GetSubscriptionDetailsResponse
     * <p/>
     * If response is ready, call to <code>future.get()</code> 
     * will return GetSubscriptionDetailsResponse. 
     * <p/>
     * If response is not ready, call to <code>future.get()</code> will block the 
     * calling thread until response is returned. 
     * <p/>
     ...
     * <pre>
     *
     *  List&lt;Future&lt;GetSubscriptionDetailsResponse&gt;&gt; responses = new ArrayList&lt;Future&lt;GetSubscriptionDetailsResponse&gt;&gt;();
     *  for (GetSubscriptionDetailsRequest request : requests) {
     *      responses.add(client.getSubscriptionDetailsAsync(request));
     *  }
     *  for (Future&lt;GetSubscriptionDetailsResponse&gt; future : responses) {
     *      while (!future.isDone()) {
     *          Thread.yield();
     *      }
     *      try {
     *          GetSubscriptionDetailsResponse response = future.get();
     *      // use response
     *      } catch (Exception e) {
     *          if (e instanceof AmazonFPSException) {
     *              AmazonFPSException exception = AmazonFPSException.class.cast(e);
     ...
     * @return Future&lt;GetSubscriptionDetailsResponse&gt; future pointer to GetSubscriptionDetailsResponse
     * 
     */
    public Future<GetSubscriptionDetailsResponse> getSubscriptionDetailsAsync(final GetSubscriptionDetailsRequest request) {
        Future<GetSubscriptionDetailsResponse> response = executor.submit(new Callable<GetSubscriptionDetailsResponse>() {

            public GetSubscriptionDetailsResponse call() throws AmazonFPSException {
                return getSubscriptionDetails(request);
            }
        });
        return response;
    }
    ...
    /**
     * Non-blocking Get Recipient Verification Status 
     * <p/>
     * Returns <code>future</code> pointer to GetRecipientVerificationStatusResponse
     * <p/>
     * If response is ready, call to <code>future.get()</code> 
     * will return GetRecipientVerificationStatusResponse. 
     * <p/>
     * If response is not ready, call to <code>future.get()</code> will block the 
     * calling thread until response is returned. 
     * <p/>
     ...
     *      responses.add(client.getRecipientVerificationStatusAsync(request));
     *  }
     ...
     * @return Future&lt;GetRecipientVerificationStatusResponse&gt; future pointer to GetRecipientVerificationStatusResponse
     * 
     */
    public Future<GetRecipientVerificationStatusResponse> getRecipientVerificationStatusAsync(final GetRecipientVerificationStatusRequest request) {
        Future<GetRecipientVerificationStatusResponse> response = executor.submit(new Callable<GetRecipientVerificationStatusResponse>() {

            public GetRecipientVerificationStatusResponse call() throws AmazonFPSException {
                return getRecipientVerificationStatus(request);
            }
        });
        return response;
    }

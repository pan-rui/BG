...
public  class AmazonFPSMock implements AmazonFPS {
     ...
     *
     * @throws com.amazonaws.fps.AmazonFPSException
     */
     ...
     * @throws com.amazonaws.fps.AmazonFPSException
     */
    public GetTransactionsForSubscriptionResponse getTransactionsForSubscription(GetTransactionsForSubscriptionRequest request)
        throws AmazonFPSException {
        GetTransactionsForSubscriptionResponse response;
        try {
            response = (GetTransactionsForSubscriptionResponse)getUnmarshaller().unmarshal
                    (new InputSource(this.getClass().getResourceAsStream("GetTransactionsForSubscriptionResponse.xml")));
     ...
     * @throws com.amazonaws.fps.AmazonFPSException
     */
    public GetSubscriptionDetailsResponse getSubscriptionDetails(GetSubscriptionDetailsRequest request)
        throws AmazonFPSException {
        GetSubscriptionDetailsResponse response;
        try {
            response = (GetSubscriptionDetailsResponse)getUnmarshaller().unmarshal
                    (new InputSource(this.getClass().getResourceAsStream("GetSubscriptionDetailsResponse.xml")));
     ...
     * @throws com.amazonaws.fps.AmazonFPSException
     */
    public GetRecipientVerificationStatusResponse getRecipientVerificationStatus(GetRecipientVerificationStatusRequest request)
        throws AmazonFPSException {
        GetRecipientVerificationStatusResponse response;
        try {
            response = (GetRecipientVerificationStatusResponse)getUnmarshaller().unmarshal
                    (new InputSource(this.getClass().getResourceAsStream("GetRecipientVerificationStatusResponse.xml")));
